...
class WholesaleSeries extends Ui
{
    ...
    public function _groupname($data)
    {
    	...
    	return '<div class="media">
			...
			<div class="media-body">'.
				'<a href="'.asset('/wholesale/'.$data['id']).'/edit" data-plugin="lightbox"><strong ref="name">'.$data['name'].'</strong></a>'.
    ...
    {
    	$val = '<a href="'.asset('/wholesale/'.$data['id']).'/edit" data-plugin="lightbox" class="btn btn-sm btn-primary" title="แก้ไข"><i class="fa fa-pencil"></i></a>';
		$val .= '<a href="'.asset('/wholesale/'.$data['id'].'/delete').'" data-plugin="lightbox" class="btn btn-sm btn-danger ml-2" title="ลบ"><i class="fa fa-remove"></i></a>';
