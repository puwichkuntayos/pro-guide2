...
class GuideDatable extends Ui
{
    ...
    public function keys()
    {
        ...
        $key[] = array('id'=>'remake', 'label'=>'หมายเหตุ');
    ...
    public function action($data)
    {
        ...
        $val .= '<a href="'.asset('//'.$data->id).'/edit" class="btn btn-sm btn-primary ml-1" title="ตรวจสอบข้อมูล"><i class="fa fa-pencil"></i></a>';
