...
class TotalPaymentDatatable extends Ui
{
		...
		public function groupName($data)
		{
			return '<div class="media">'.
						...
						'<div class="media-body">'.
								...
								'<a href="'.asset('/totalpayments/'.$data->id).'/edit" data-plugin="lightbox">'.
    ...
    public function action($data)
    {
        $val ='';
				...
				switch ($data->status) {
						case 1:
								$val .= '<a href="'.asset('/totalpayments/'.$data->id).'/edit" data-plugin="lightbox" class="btn btn-sm btn-primary m-1" title="ตรวจสอบข้อมูล"><i class="fa fa-check"></i></i></a>';
								$val .= '<a href="'.route('pdf.totalpayments',$data->id).'" target="_blank" class="btn btn-secondary btn-sm  m-1" ><i class="fa fa-file"></i></a>';
						...
						// case 4:
						// 		$val .= '<a href="#" class="btn btn-sm btn-primary m-1 text-info" style=""><i class="fa fa-check"></i></a>';
						// 		$val .= '<a href="'.route('pdf.totalpayments',$data->id).'" target="_blank" class="btn btn-secondary btn-sm  m-1" ><i class="fa fa-file"></i></a>';
						// break;

						case 3:
								// $val .= '<a href="#" class="btn btn-sm btn-primary m-1 text-primary" style=""><i class="fa fa-check"></i></a>';
								// $val .= '<a href="'.asset('/totalpayments/'.$data->id).'/edit" data-plugin="lightbox" class="btn btn-sm btn-primary m-1" title="ตรวจสอบข้อมูล"><i class="fa fa-check"></i></i></a>';
								$val .= '<a href="'.route('pdf.totalpayments',$data->id).'" target="_blank" class="btn btn-secondary btn-sm  m-1" ><i class="fa fa-file"></i></a>';
							break;
				}
      		// $val .= '<a href="'.route('pdf.percentpdf',$data->id).'" target="_blank" class="btn btn-secondary btn-sm  m-1" ><i class="fa fa-file"></i></a>';
		return $val;
    }
