...
@section('title', 'Easy Web Tour - '. __('New Password'))
...
<div class="d-md-flex align-items-center justify-content-around h-100 text-uppercase">
    ...
    <div class="px-5 px-md-0">
        <div class="CardLayout">
            ...
            <header><h4 class="spectrum-Heading1">{{ __('กรุณาตั้งรหัสผ่านใหม่ของท่าน') }}</h4></header>

            <form method="POST" action="{{ asset('/change_password') }}" aria-label="{{ __('Login') }}">
                @csrf

                <div class="form-group">
                    <label for="password" class="col-form-label text-md-right">{{ __('รหัสผ่านใหม่') }}</label>
                ...
                <div class="form-group form-group-password">
                    <label for="password" class="col-form-label text-md-right">{{ __('กรอกรหัสผ่านของท่านอีกครั้ง') }}</label>
