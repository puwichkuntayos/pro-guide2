...
<!-- end scrlip  -->
    ...
    <div class="h-100 d-flex align-items-center justify-content-center">
        ...
        <div aria-labelledby="swal2-title" aria-describedby="swal2-content">
          ...
          </div><img class="swal2-image" style="display: none;"><h2 class="swal2-title" id="swal2-title" style="display: flex;">ลงทะเบียนสำเร็จแล้ว</h2><button type="button" class="swal2-close" aria-label="Close this dialog" style="display: none;">×</button></div><div class="swal2-content"><div id="swal2-content" class="swal2-html-container" style="display: block;">กรุณารอผลการยืนยันการลงทะเบียนผ่านทางอีเมลภายใน 24 ชั่วโมง</div><input class="swal2-input" style="display: none;"><input type="file" class="swal2-file" style="display: none;"><div class="swal2-range" style="display: none;"><input type="range"><output></output></div><select class="swal2-select" style="display: none;"></select><div class="swal2-radio" style="display: none;"></div><label for="swal2-checkbox" class="swal2-checkbox" style="display: none;"><input type="checkbox"><span class="swal2-label"></span></label><textarea class="swal2-textarea" style="display: none;"></textarea><div class="swal2-validation-message" id="swal2-validation-message"></div></div>
