        ...
        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px; border">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td>
                        <center>
                        <img style="width: 100%; height: auto;" src="https://probookingcenter.com/public/images/demo/about/a1.jpg">
                        <img style="width: 100%; height: auto;" src="https://probookingcenter.com/public/images/demo/about/a2.jpg">
                        <img style="width: 100%; height: auto;" src="https://probookingcenter.com/public/images/demo/about/a3.jpg">
                        <img style="width: 100%; height: auto;" src="https://probookingcenter.com/public/images/demo/about/a4.jpg">
                            <p>ขอเชิญมาเข้าร่วมทำงานกับเรา</p>

                            <button type="submit" class="button"  ><a border="0" href="{{ asset('/guides/register/'.$data['id']) }}">กดสมัครผ่านหน้าเว็บ</a></button>

                            <br><br>
                            <p>*อีเมลล์นี้จะมีอายุเพียง 30 นาที</p>
                        </center>
                    </td>
                </tr>
