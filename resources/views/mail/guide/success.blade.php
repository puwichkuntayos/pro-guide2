    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="#ff8400">
        ...
        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px; border">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td>
                        <p>ยินดีด้วย, คุณ{{$data['name'] ?? ''}}</p>  <p>ยินดีด้วย, คุณ{{$data['lastname'] ?? ''}}</p>

                        <p>บัญชีของคุณได้รับการอนุมัติเข้าร่วมมาเป็น Guide/TL</p>
                        <p>ผู้ใช้จะได้รับ username และ password เพื่อเข้าสู่ระบบ</p>



                        @if (!empty( $data['message'] ))
                        <textarea name=""  border="0"  id="" cols="30" readonly  rows="10" style="background-color:#ffffff ">{{$data['message']}}</textarea>
                        ...
                        <p>ผู้ใช้สามารถเข้าสู่ระบบผ่านทางลิงก์นี้: </p>
                        <button class="button" type="submit"><a href="{{ asset('/login') }}">กดเพื่อเข้าสู่ระบบผ่านหน้าเว็บไซต์</a></button>
